...
// export const CARTITEMS: KeyedObj<Item> = {
// }

export const CARTS: KeyedObj<DbShoppingCart> = {
  '1': {
    items: {}
  },
  '2': {
...
export const USERS: KeyedObj<DbUser> = {
  '1': {
    // id: 1,
...
export const PRODUCTS: KeyedObj<DbProduct> = {
  ...
  '-L0ZiFWvItP4YFXtYEH_': {
    category: 'web-dev',
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/0/0c/Wordpress_logo_8.png',
    price: 22,
